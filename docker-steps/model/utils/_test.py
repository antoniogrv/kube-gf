...
def init_test(
    ...
    parent_dir: str = os.path.join(result_dir, task)
    test_dir: str = os.path.join(result_dir, task)
    log_dir: str = os.path.join(parent_dir, 'log')
    model_dir: str = os.path.join(parent_dir, 'model')
