...
def component_path(dir: str) -> str:
    return os.path.join(os.path.dirname(__file__), f"components/fusion-classifier/{dir}/component.yaml")
...
if __name__ == '__main__':
    ...
    dataset_train_config_op = kfp.components.load_component_from_file(component_path("dataset/train"))
    ...
    #client = kfp.Client()
    #client.create_run_from_pipeline_func(fusion_classifier, arguments={})